        ...
        <div className="relative w-full flex justify-center items-end mt-8">
          ...
          >
            <a
              ...
              className="text-sm text-neutral-500 dark:text-neutral-400 hover:text-black dark:hover:text-white transition-colors flex items-center gap-2 group"
            >
      ...
      >
        ...
        <div className="mt-8">
          <a
            ...
            className="inline-flex items-center gap-2 text-neutral-900 dark:text-white border-b border-neutral-900 dark:border-white pb-1 hover:text-purple-600 dark:hover:text-purple-400 hover:border-purple-600 dark:hover:border-purple-400 transition-colors"
          >
